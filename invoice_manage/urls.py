...
urlpatterns = [
    ...
    path('apply_invoice_record/', views.apply_invoice_record, name='apply_invoice_record'),
    ...
    # 已开发票相关
    path('invoice_info/', views.invoice_info, name='invoice_info'),
    ...
    # 发票作废相关
    path('void_red_info/', views.void_red_info, name='void_red_info'),
