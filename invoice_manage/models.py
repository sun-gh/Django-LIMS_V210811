...
class ReimburseFile(models.Model):
    ...
    # 定义报账文件
    file = models.FileField(verbose_name="报账文件", max_length=100, blank=True, null=True)
...
class ApplyInvoice(models.Model):
    ...
    invoice_sum = models.PositiveIntegerField(verbose_name="开票金额")
...
class InvoiceInfo(models.Model):
    ...
    payment_sum = models.PositiveIntegerField(verbose_name="回款金额", blank=True, null=True)
    note = models.CharField(max_length=128, verbose_name="备注", blank=True, null=True)
