...
class UnitInvoice(models.Model):
    ...
    duty_paragraph = models.CharField(max_length=128, verbose_name="税号", blank=True, null=True)
...
class CustomerInfo(models.Model):
    ...
    def __str__(self):
        return self.customer_name + "----" + str(self.unit)

    class Meta:
        ordering = ["-c_time"]
        unique_together = ['customer_name', 'phone', 'unit']
        verbose_name = "客户信息"
        verbose_name_plural = verbose_name
